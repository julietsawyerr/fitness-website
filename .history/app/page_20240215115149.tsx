  ...
  return (
    <section className="flex flex-col gap-16 py-10 border-2 md:h-full md:pb-0">
      ...
      <div className="md:flex mx-auto w-5/6 items-center justify-center md:h-5/6">
        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          <div className="md:-mt-20">
            <div className="relative">
              <div className="before:absolute before:-top-20 before:-left-20 befo-re:z-[-1] md:before:content-evolvetext">
        ...
        {/* BUTTONS */}
          <div className="mt-8 flex text- items-center gap-8 md:justify-start">
          <Link 
          href='/member' 
