  ...
  return (
    <nav>
      ...
      >
          ...
          {isOpen && (
            <div className="absolute top-[90px] h-screen w-full z-40 bg-primary-100 drop-shadow-xl border border-red-950 sm:hidden">
               <div className='flex flex-col items-center justify-b w-full h-full'>
                      {links.map(({href, name}) => (
                        <Link  
                          key={name} 
                          href={href}
