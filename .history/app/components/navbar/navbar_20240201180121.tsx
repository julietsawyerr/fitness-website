            ...
            w-full gap-16`}>
                ...
                <div className={`${flexBetween} w-full`}>
                  <div className={`${flexBetween} gap-8 text-sm `}>
                    <Link href='#first' scroll={false}>Home</Link>

                    <Link href='#second' scroll={false}>Benefits</Link>

                    <Link href='#third' scroll={false}>Our Classes</Link>

                    <Link href='#forth' scroll={false}>Contact us</Link>
                  </div>
