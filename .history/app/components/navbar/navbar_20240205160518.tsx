...
const Navbar = (props: Props) => {
 ...
 const handleClick = () => {
  ...
  return (
    <nav>
      <div 
        className={`${flexBetween} fixed z-2 top-0 w-full py-6 bg-red-100 border-2 border-gray-500`}
      >
          ...
          {isOpen && (
             <div className="fixed right-0 bottom-0 z-1 h-full w-[300px] bg-primary-100 drop-shadow-xl">
             {/* CLOSE ICON */}
