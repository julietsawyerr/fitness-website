  ...
  return (
    <nav>
      ...
      >
          <div className={`${flexBetween} mx-auto w-5/6 border border-sky-400`}>
            ...
            w-full gap-16`}>
                ...
                <div className="sm:hidden">
                  ...
                  >
                    <Bars3Icon className='h-6 w-6 text-white'/> : <XMarkIcon  className='h-6 w-6 text-white'/>}
                  </button>
                </div>
            </div>
          </div>
          ...
          {isOpen && (
             <div className="flex flex-col justify-around items-center fixed top-0 bottom-0 z-40 h-full w-full bg-primary-100">
             
             
             {/* Menu */}
             <div className='flex flex-col items-center justify-center mx-auto w-5/6 border-2 border-gray-800 py-6'>
             ...
             {links.map(({href, name}) => (
              ...
              {/* SIGN IN BUTTON */}
              <div className='flex flex-col items-center justify-center grow  gap-2 p-3 text-sm font-medium my-8 hover:text-blue-600'>
                <p>Sign In</p>
                <button>Become a Member</button>
              </div>
