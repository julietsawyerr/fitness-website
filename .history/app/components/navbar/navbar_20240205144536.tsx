...
const Navbar = (props: Props) => {
 ...
 const handleClick = () => {
  ...
  return (
    <nav>
      <div 
        className={`${flexBetween} relative fixed z-30 top-0 w-full py-6 bg-red-100 border-2 border-gray-500`}
      >
          ...
          {isOpen && (
            <div className="absolute top-[88px]] h-screen w-full bg-primary-100 drop-shadow-xl"></div>
          )}
      </div>
    </nav>
  )
