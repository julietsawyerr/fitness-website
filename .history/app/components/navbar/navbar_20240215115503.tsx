                  ...
                  <div className='flex'>
                      {links.map(({href, name}) => (
                        <Link  
                          key={name} 
                          href={href}
                          className={clsx("flex grow items-center justify-center gap-2  p-3 text-sm font-medium hover:text-primary-500",
                          {
          ...
          {isOpen && (
             ...
             {links.map(({href, name}) => (
                        <Link  
                          ...
                          href={href}
                          onClick={handleClick}
                          className={clsx("flex grow  gap-2  p-3 text-sm font-medium hover:text-primary-500",
                          {
                             'text-primary-500': pathname === href
                          }
                          )}
             ...
             {/* <div>
                      {links.map(({href, name}) => (
                        <Link  
                          ...
                          href={href}
                          onClick={handleClick}
                          className={clsx("flex grow  gap-2  p-3 text-base font-medium hover:text-blue-600",
                          {
