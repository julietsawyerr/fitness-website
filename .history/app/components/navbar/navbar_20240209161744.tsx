...
const Navbar = (props: Props) => {
 ...
 const handleClick = () => {
  ...
  return (
    <nav>
      <div 
        className={`${flexBetween} fixed z-30 top-0 w-full py-6 bg-red-100`}
      >
  ...
  <span className="relative inline-flex rounded-full h-3 w-3 bg-sky-500"></span>
          ...
          {isOpen && (
             <div className="flex flex-col justify-around items-center sticky top-0 bottom-0 z-40 h-full w-full bg-primary-100 sm:hidden">
