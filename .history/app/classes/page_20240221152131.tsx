...
const OurClasses = () => {
  return (
    <session className='mx-auto min-h-full w-5/6 py-20 mt-20'>
      <MotionDiv 
      ...
      >
        ...
        <p>Our classes focus on the technique to effectively engage the muscles for strength building and muscle definition.</p>
      </MotionDiv>
