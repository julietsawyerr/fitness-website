...
const Contact = (props: Props) => {
  ...
  const inputStyle = `w-full rounded-lg bg-primary-300 px-5 py-3 placeholder-white text-base font-medium`;
        ...
        <div className="mt-10 basis-3/5 md:mt-0">
          ...
          onSubmit={handleSubmit}
           ...
           >
              <input 
                type="text" 
                className="w-full rounded-lg bg-primary-300 px-5 py-3 placeholer-white" 
              />
           </form>
        </div>
      </div>
