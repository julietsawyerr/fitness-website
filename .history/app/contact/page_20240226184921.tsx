...
const Contact = (props: Props) => {
  ...
  const inputStyle = `w-full rounded-lg bg-primary-300 px-5 py-3 mt-4 placeholder-white text-base font-medium active:bg-primary-300 `;
          ...
          onSubmit={handleSubmit}
           ...
           <div className="relative mt-16 basis-2/5 md:mt-0">
            ...
            <Image
                ...
                src='/asset/PS C:\Users\julie\Documents\MY_WORK\n

                added 1 package, and audited 369 pack
                
                  run `npm fund` for details
                
                found 0 vulnerabilities
                PS C:\Users\julie\Documents\MY_WORK\nextjs project\nextjs-fitness-app>
                '
              />
            </div>
           </div>
