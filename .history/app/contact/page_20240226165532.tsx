...
const Contact = (props: Props) => {
  ...
  const inputStyle = `w-full rounded-lg bg-primary-300 px-5 py-3 mt-4 placeholder-white text-base font-medium`;
           ...
           >
              ...
              {errors.message && (
                <p className="mt-1 text-primary-500">
                  ...
                  {errors.message.type === 'maxLength' && 'Max length is 00 character'}
                </p>
              )}
           </form>
        </div>
